...
def is_post_expired(post):
    current_time = datetime.utcnow()
    return post.expiration_time < current_time
...
class PostMessage(Resource):
    ...
    def post(self):
        ...
        post_parser.add_argument('expiration_minutes', help='This field cannot be blank', required=True)
    ...
    def get(self, topic_name, post_id=None):
        try:
            ...
            for message in messages:
                ...
                comments = Comment.query.filter_by(post_id=message.id).all()
...
class UserInteractions(Resource):
    ...
    def post(self, post_id):
        try:
            ...
            if current_user == post.owner_name:
                return {'message': 'Post owner cannot like their messages'}, 400
